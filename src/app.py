...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice teamwork, conditioning, and competitive soccer skills",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["oliver@mergington.edu", "ava@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Build basketball fundamentals through drills and friendly matches",
    ...
    "Drama Club": {
        "description": "Develop stage presence through acting, improvisation, and performance",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["charlotte@mergington.edu", "elijah@mergington.edu"]
    },
    "Debate Team": {
        "description": "Sharpen critical thinking and public speaking through structured debate",
        "schedule": "Mondays and Thursdays, 3:30 PM - 4:45 PM",
        "max_participants": 12,
        "participants": ["amelia@mergington.edu", "henry@mergington.edu"]
    },
    "Math Club": {
        "description": "Solve challenging problems and explore advanced mathematical ideas",
